...
export default function Home() {
  ...
  return (
    <div>
      ...
      <section 
        ref={heroRef} 
        className="relative h-[85vh] md:h-screen min-h-[600px] md:min-h-[700px] flex items-center justify-center overflow-hidden"
      >
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 max-w-5xl mx-auto">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-cream mb-6 sm:mb-8 leading-[0.95]">
            {settings.hero_tagline || 'Stories That\nStay With You'}
          </h1>
          <p className="text-cream/60 text-base sm:text-lg md:text-xl max-w-2xl mx-auto mb-8 sm:mb-12 font-light leading-relaxed px-2 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            <Link 
              to="/books" 
              className="px-8 sm:px-10 py-3.5 sm:py-4 bg-warm text-cream rounded-lg font-medium hover:bg-warm/90 transition-all hover:scale-105 active:scale-95 text-center text-sm sm:text-base"
            >
              Explore Works
            </Link>
            <Link 
              to="/about" 
              className="px-8 sm:px-10 py-3.5 sm:py-4 border border-cream/30 text-cream rounded-lg font-medium hover:bg-cream/10 transition-all active:scale-95 text-center text-sm sm:text-base"
            >
              About the Author
            </Link>
          </div>
      ...
      {/* Featured Books - Mobile Grid */}
      <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-12 bg-cream">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-16 gap-4 sm:gap-6">
            <div>
              <p className="text-warm text-xs sm:text-sm uppercase tracking-[0.3em] mb-3 sm:mb-4">Latest Works</p>
            ...
            <Link 
              to="/books" 
              className="group flex items-center gap-2 sm:gap-3 text-ink hover:text-warm transition-colors w-fit"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12">
            {books.map((book, i) => (
              ...
              >
                <div className="relative aspect-[2/3] mb-4 sm:mb-6 overflow-hidden rounded-lg bg-parchment">
                ...
                <div>
                  ...
                  <h3 className="font-serif text-xl sm:text-2xl text-ink group-hover:text-warm transition-colors mb-1 sm:mb-2">
                    {book.title}
                  </h3>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
          <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
            <div className="relative order-1 lg:order-1">
              <div className="aspect-[4/5] rounded-lg overflow-hidden max-w-md lg:max-w-none mx-auto lg:mx-0">
              ...
              <div className="absolute -bottom-4 sm:-bottom-6 -right-4 sm:-right-6 w-24 sm:w-32 h-24 sm:h-32 border-2 border-warm/30 rounded-lg -z-10" />
            </div>
            ...
            <div className="order-2 lg:order-2 text-center lg:text-left">
              ...
              <div className="prose prose-base sm:prose-lg text-stone leading-relaxed mb-8 sm:mb-10">
                <p className="mb-4">
      ...
      {/* Latest Blog Post - Mobile Responsive */}
      {latestPost && (
        <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 lg:px-12 bg-cream">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 sm:mb-16 gap-4 sm:gap-6">
              <div>
                <p className="text-warm text-xs sm:text-sm uppercase tracking-[0.3em] mb-3 sm:mb-4">From the Journal</p>
            ...
            >
              ...
              <div className="text-center lg:text-left">
                <p className="text-muted text-sm mb-3 sm:mb-4">
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-ink text-cream">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="w-12 h-px bg-warm mx-auto mb-8 sm:mb-10" />
          <blockquote className="font-serif text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-tight mb-8 sm:mb-10">
